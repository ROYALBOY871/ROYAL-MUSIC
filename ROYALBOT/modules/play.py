...
from ROYALBOT.config import ARQ_API_KEY
...
async def play(_, message: Message):
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://te.legra.ph/file/758709448f6c3853f07b8.jpg"
        ...
        query = toxt
        await lel.edit("🎵 <b>Ruk ja thoda....</b>")
        ...
        try:
            ...
            await lel.edit(
                "Spelling thik kr beta spelling mistakes ho gyii hai......"
            )
            print(str(e))
            return
        try:    
            ...
            if (dur / 60) > DURATION_LIMIT:
                 await lel.edit(f"❌ Video bahut bada hai tu Buddha ho jayega sunte sunte iss liye me play na kr rha....!")
                 return
        except:
            pass        
        dlurl=url
